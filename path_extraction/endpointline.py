...
def measure(vid):
    ...
    while x1 > 0:
        ...
        if all(
            pixel_color == [255, 0, 0]
        ):  # Checking for blue color (assuming BGR values)
    ...
    cv2.putText(
        image, text2, (halfx + 50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2
    )
    ...
    cv2.putText(
        image, text3, (x - 400, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2
    )
