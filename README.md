...
*Walking Path Post-filtering Function, and Black Pixel to Node Conversion*
...
*Shortest Distance Between Points, and Simulation on Shortest Path Generation*
...
*Screenshot from Real-time Distance Analysis and Hough Line Path Detection*
